...
if __name__ == "__main__":
    ...
    # NẠP MÔ HÌNH: Random Forest + K-Means
    ...
    print("Running Scenario 2: 2-Layer Integrated System (Random Forest + K-Means)...")
