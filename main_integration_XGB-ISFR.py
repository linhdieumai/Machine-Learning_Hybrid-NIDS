...
if __name__ == "__main__":
    ...
    ids = HybridIDS('supervised_xgb_model.pkl', 'unsupervised_isoforest_model.pkl')    
    ...
    print("Running Scenario 2: 2-Layer Integrated System (XGboost + IsoForest)...")
