...
# Gộp chung lại thành 1 bảng lớn
...
X_test_scaled_for_sup = scaler_sup.transform(X_test) # Transform tập test để test mô hình Supervised
...
np.save('Y_unsup_train.npy', Y_unsup.values)
